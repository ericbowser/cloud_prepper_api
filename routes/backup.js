 ...
 *       bearerFormat: JWT
 * 
 * /api/backup/generate-restore-script:
 *   get:
...
router.get('/generate-restore-script', authenticateToken, requireAdmin, async (req, res) => {
  try {
    ...
    const backupPath = path.join('C:/Projects/cloud_prepper_api/backups', backupFileName);
...
router.get('/download/:filename', authenticateToken, requireAdmin, async (req, res) => {
  try {
    ...
    const filePath = path.join('C:/Projects/cloud_prepper_api/backups', fileName);
...
router.get('/list', authenticateToken, requireAdmin, async (req, res) => {
  try {
    ...
    const backupDir = 'C:/Projects/cloud_prepper_api/backups';
